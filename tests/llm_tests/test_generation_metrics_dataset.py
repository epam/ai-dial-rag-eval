...
def test_inference_dataset(tmp_path, llm):
    ...
    assert metrics.metadata.metrics == {
        ...
        "ctx_ans_inference_min": pytest.approx(0.333333, abs=1e-4),
        "ctx_ans_inference_max": pytest.approx(0.333333, abs=1e-4),
        ...
        "fct_ans_inference": pytest.approx(0.333333, abs=1e-4),
        "fct_ans_inference_min": pytest.approx(0.333333, abs=1e-4),
        "fct_ans_inference_max": pytest.approx(0.333333, abs=1e-4),
    ...
    print(set(metrics_df.columns.tolist()))
    assert set(metrics_df.columns.tolist()) == {
        ...
        "documents",
        "ctx_ans_inference",
        "ctx_ans_inference_min",
        "ctx_ans_inference_max",
        "ctx_ans_json",
        "ctx_ans_highlight",
        "ctx_ans_errors",
        "ans_gt_inference",
        "ans_gt_inference_min",
        "ans_gt_inference_max",
        "ans_gt_json",
        "ans_gt_highlight",
        "ans_gt_errors",
        "ans_fct_inference",
        ...
        "ans_fct_errors",
        "fct_ans_inference",
        "fct_ans_inference_min",
        "fct_ans_inference_max",
        "fct_ans_json",
        "fct_ans_highlight",
        "fct_ans_errors",
        "gt_ans_inference",
        ...
        "gt_ans_errors",
        "answer_refusal",
        "answer_refusal_error",
        "ground_truth_refusal",
        "ground_truth_refusal_error",
        "mean_inference",
        "median_inference",
        "facts",
        "facts_ranks",
