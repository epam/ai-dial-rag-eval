...
The algorithm incurs significant costs due to the number of input tokens.

Considering the balance between quality and price, the following models are recommended:
